 ...
 *
 */
public class HarmonicMeanAnalysisParser extends AbstractXMLObjectParser {

    public static final String HARMONIC_MEAN_ANALYSIS = "harmonicMeanAnalysis";
    ...
    public static final String SMOOTHED_ESTIMATE = "smoothedEstimate";

    public String getParserName() {
        return HARMONIC_MEAN_ANALYSIS;
    }
    ...
    private final XMLSyntaxRule[] rules = {
            ...
            AttributeRule.newBooleanRule(SMOOTHED_ESTIMATE, true),
